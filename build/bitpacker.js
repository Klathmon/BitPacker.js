...
var BitPacker = function () {
  /**
   * Creates the object
   */

  function BitPacker() {
    _classCallCheck(this, BitPacker);
  ...
  BitPacker.prototype.packPixel = function packPixel(red, green, blue, alpha) {
  ...
  BitPacker.prototype.unpackPixel = function unpackPixel(packedPixel) {
    if (this._isLittleEndian) {
      return [packedPixel & 0x000000ff, (packedPixel & 0x0000ff00) >>> 8, (packedPixel & 0x00ff0000) >>> 16, (packedPixel & 0xff000000) >>> 24];
    } else {
      return [(packedPixel & 0xff000000) >>> 24, (packedPixel & 0x00ff0000) >>> 16, (packedPixel & 0x0000ff00) >>> 8, packedPixel & 0x000000ff];
    }
  };
  ...
  BitPacker.prototype._checkIsLittleEndian = function _checkIsLittleEndian() {
